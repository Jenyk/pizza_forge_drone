...
public class ToppingArquillianDroneTest {
	...
	public void testCRUD() throws Exception {
		...
		browser.findElement(By.linkText("Topping")).click();
		browser.findElement(By.linkText("Create New")).click();

		// name
		WebElement nameTextBox = browser.findElement(By.id("create:toppingBeanToppingName"));
		nameTextBox.clear();
		...
		browser.findElement(By.id("search:toppingBeanPageItems:0:itemName")).click();

		try {
			WebElement nameResult = browser.findElement(By.id("toppingBeanToppingName"));
		...
		// name
		nameTextBox = browser.findElement(By.id("create:toppingBeanToppingName"));
		nameTextBox.clear();
		name = "TestTopping2";
		nameTextBox.sendKeys(name);
